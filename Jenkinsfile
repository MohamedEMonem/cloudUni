pipeline{
    ...
    environment{
        ...
        EB_ENV_NAME = "The-dokkan-deploy-env-1"
    ...
    stages{
        ...
        stage('build'){
            steps{
                ...
                sh 'docker build --build-arg VITE_API_URL=http://dokkan-env.eba-sdbipm8i.us-east-1.elasticbeanstalk.com/api -f ./Frontend/Dockerfile -t ${DOCKER_IMAGE_FRONT}:${BUILD_NUMBER} -t ${DOCKER_IMAGE_FRONT}:latest ./'
            }
        }
