    ...
    stages{
        ...
        stage('build'){
            steps{
                ...
                sh 'docker build --build-arg VITE_API_URL=http://dokkan.us-east-1.elasticbeanstalk.com -f ./Frontend/Dockerfile -t ${DOCKER_IMAGE_FRONT}:${BUILD_NUMBER} -t ${DOCKER_IMAGE_FRONT}:latest ./'
            }
        }
